...
void MainGame::init() {
    ...
    m_spriteFont = std::unique_ptr<GameEngine::SpriteFont>(new GameEngine::SpriteFont("Fonts/chintzy.ttf", 40));
...
struct BallSpawn {
    BallSpawn(const GameEngine::ColorRGBA8& colr,
...
void MainGame::initBalls() {
    ...
    // Initialize the grid
    m_grid = std::unique_ptr<Grid>(new Grid(m_screenWidth, m_screenHeight, CELL_SIZE));
...
#define ADD_BALL(p, ...) \
    ...
    ADD_BALL(1.0f, GameEngine::ColorRGBA8(255, 255, 255, 255),
             2.0f, 1.0f, 0.1f, 7.0f, totalProbability);
    ADD_BALL(1.0f, GameEngine::ColorRGBA8(1, 254, 145, 255),
             2.0f, 2.0f, 0.1f, 3.0f, totalProbability);
    ADD_BALL(1.0f, GameEngine::ColorRGBA8(177, 0, 254, 255),
             3.0f, 4.0f, 0.0f, 0.0f, totalProbability)
    ADD_BALL(1.0f, GameEngine::ColorRGBA8(254, 0, 0, 255),
             3.0f, 4.0f, 0.0f, 0.0f, totalProbability);
    ADD_BALL(1.0f, GameEngine::ColorRGBA8(0, 255, 255, 255),
             3.0f, 4.0f, 0.0f, 0.0f, totalProbability);
    ADD_BALL(1.0f, GameEngine::ColorRGBA8(255, 255, 0, 255),
             3.0f, 4.0f, 0.0f, 0.0f, totalProbability);
    // Make a bunch of random ball types
    for (int i = 0; i < 10000; i++) {
        ADD_BALL(1.0f, GameEngine::ColorRGBA8(r2(randomEngine), r2(randomEngine), r2(randomEngine), 255),
...
void MainGame::drawHud() {
    const GameEngine::ColorRGBA8 fontColor(255, 0, 0, 255);
